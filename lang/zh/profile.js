const cht_profile = {
    ...
    projects: {
        ...
        items: [{
            ...
            description: [
                "完成可以多人連線且大地圖的遊戲",
                "使用 Java packages 完成 UDP 廣播和指導隊員完成遊戲核心邏輯",
                "教導組員學習用 git 進行版本控管"
            ]
        }, {
            ...
            title: "Air Hockey",
            url: "https://hanvincent.github.io/Air_Hockey_Game/",
    ...
    awards: {
        ...
        items: [{
            ...
            time: 2015,
            award: "104-1 殷省三先生紀念獎助學金",
            host: "國立中央大學"
        }, {
            time: 2015,
            award: "103-2 殷省三先生紀念獎助學金",
            host: "國立中央大學"
        }, {
            time: 2015,
